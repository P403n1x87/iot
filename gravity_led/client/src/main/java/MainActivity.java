package com.p403n1x87.ctrl_ws_client;
...
public class MainActivity extends Activity implements SensorEventListener
{
  ...
  private void start() {
    ...
    if (webSocketClient == null) {
      Log.e("ctrl_ws_client", "Unable to create a WebSocket client.");
      return;
    }
  ...
  private void stop() {
    ...
    if (webSocketClient == null) {
      Log.e("ctrl_ws_client", "Attempt to close a null WebSocket client.");
      return;
    }
  ...
  private WebSocketClient buildWebSocketClient () {
    ...
    try {
      ...
      Log.e("ctrl_ws_client", "Invalid URI.");
      return null;
    }
    ...
    return new WebSocketClient(uri, new Draft_17()) {
      ...
      public void onError(Exception e) {
        Log.e("ctrl_ws_client", "Error " + e.getMessage());
        runOnUiThread(new Runnable() {
          @Override
          public void run() {
